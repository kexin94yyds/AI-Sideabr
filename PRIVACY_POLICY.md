...
- Host permissions on supported AI and productivity domains, plus all-sites access used to support cross-site features such as sending selected text and capturing screenshots into the side panel without requiring page-by-page re-authorization.
